...
public class CustomShellFlyoutRenderer
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GadgetStoreApp.Droid.CustomShellFlyoutRenderer, GadgetStoreApp.Android", CustomShellFlyoutRenderer.class, __md_methods);
	}


	public CustomShellFlyoutRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == CustomShellFlyoutRenderer.class)
			mono.android.TypeManager.Activate ("GadgetStoreApp.Droid.CustomShellFlyoutRenderer, GadgetStoreApp.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}


	public CustomShellFlyoutRenderer (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == CustomShellFlyoutRenderer.class)
			mono.android.TypeManager.Activate ("GadgetStoreApp.Droid.CustomShellFlyoutRenderer, GadgetStoreApp.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}


	public CustomShellFlyoutRenderer (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == CustomShellFlyoutRenderer.class)
			mono.android.TypeManager.Activate ("GadgetStoreApp.Droid.CustomShellFlyoutRenderer, GadgetStoreApp.Android", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2 });
	}
